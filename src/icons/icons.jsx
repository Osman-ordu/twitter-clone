...
const Svg = ({ children, className }) => {
    return (
        <svg viewBox='0 0 24 24' className={`${className} fill-current  cursor-pointer mx-auto mt-4 text-gray-lightest`}>
            {children}
        </svg>
    )
}
...
export const TwitterLogo = () => {
    return (
            <Svg className='w-10 h-10 text-primary-base'>
...
export const ExploreIcon = () => {
    return (
        <Svg className='w-7 h-7'>
            <svg viewBox="0 0 24 24"><g><path d="M10.09 3.098L9.72 7h5.99l.39-4.089 1.99.187L17.72 7h3.78v2h-3.97l-.56 6h3.53v2h-3.72l-.38 4.089-1.99-.187.36-3.902H8.78l-.38 4.089-1.99-.187L6.77 17H2.5v-2h4.46l.56-6H3.5V7h4.21l.39-4.089 1.99.187zM14.96 15l.56-6H9.53l-.56 6h5.99z"></path></g></svg>
        </Svg>
    )
}
...
export const TweetIcon = () => {
    return (
        <div className=' mx-auto bg-primary-base rounded-full m-8 w-12 h-12 transition-all duration-300 hover:bg-primary-dark'>
